...
const theme = createTheme({
  ...
  palette: {
    ...
    sidebarLinks: {
      ...
      active: "rgba(" + hexToRgb("#94a4bd") + ", 0.8)",
    },
    adminNavbarSearch: {
  ...
  overrides: {
    ...
    MuiButton: {
      ...
      containedSecondary: {
        ...
        "&:hover": {
          borderColor: themeColors.gray[90],
          backgroundColor: themeColors.gray[90],
        },
      },
      outlined: {
        padding: ".625rem 1.25rem",
      ...
      outlinedSecondary: {
        color: themeColors.secondary[20],
    ...
    MuiTableCell: {
      root: {
        ...
        padding: "1rem",
        verticalAlign: "top",
        borderTop: "1px solid " + themeColors.gray[80],
        borderBottom: "1px solid " + themeColors.gray[80],
      },
      head: {
        padding: "1rem",
        borderTop: "1px solid " + themeColors.gray[80],
    ...
    MuiLinearProgress: {
      root: {
        ...
        overflow: "hidden",
        borderRadius: ".25rem",
        backgroundColor: themeColors.gray[80] + "!important",
    ...
    MuiPaginationItem: {
      root: {
        ...
        height: "36px",
        fontSize: ".875rem",
        color: themeColors.gray[40],
        border: "1px solid " + themeColors.gray[70],
        borderRadius: "50%",
        "&:hover": {
          backgroundColor: themeColors.gray[70],
        },
      },
      outlined: {
        color: themeColors.gray[40],
    ...
    MuiBadge: {
      root: {
        ...
        "&[href] $badge:hover": {
          color: themeColors.white.main,
          backgroundColor: themeColors.neutral[10],
        },
        ...
        "&[href] $colorSecondary:hover": {
          color: themeColors.gray[10],
          backgroundColor: themeColors.secondary[95],
        },
        "&[href] $colorError:hover": {
          backgroundColor: themeColors.error[60],
        },
      },
      badge: {
        height: "unset",
      ...
      colorError: {
        color: themeColors.error[30],
        backgroundColor: themeColors.error[90],
      },
    },
    MuiTooltip: {
      tooltip: {
