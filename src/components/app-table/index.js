...
import AppTabsBar from 'components/tabs/AppTabsBar';
    ...
    return (
        ...
        >
            {showTabs && (
                ...
                >
                    {tabs?.map((tab) => {
                        return <AppTab label={tab.name} id={tab.id} key={tab.id} sx={{ fontSize: 13, mx: 0, mr: 2 }} />;
                    })}
                </AppTabsBar>
            )}
            ...
            <Stack sx={{ flex: 1 }}>
                {!data?.length && hasEmptyComponent ? (
                    ...
                    <>
                        ...
                        <TableContainer
                            sx={{ border: `0.3px solid ${theme.palette.neutral[70]}2f`, borderRadius: 1 }}
                            component={Stack}
                        >
                            <Table sx={{}}>
